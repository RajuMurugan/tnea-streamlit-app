...
if st.session_state.logged_in:
  ...
  <div style='background-color: #f9f9f9; padding: 15px; border-left: 8px solid #4CAF50; border-radius: 10px; font-size: 16px;'>
    ...
    📘 <span style='font-weight: bold;'>Check Your</span><br>
    <a href='https://globaleduhub4u.blogspot.com/2025/03/numberiq.html' target='_blank' style='text-decoration: none; color: #007bff; font-weight: bold;'>Maths IQ</a><br><br>
</div>
